...
-- {{{ Notifications
naughty.config.defaults.font             = "Oxygen-Sans 14"
-- }}}
...
config_dir = ("/home/allegrem/.config/awesome/")
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    local interface = ""
    if args["{wlp13s0 carrier}"] == 1 then
        interface = "wlp13s0"
    elseif args["{enp14s0 carrier}"] == 1 then
        interface = "enp14s0"
    else
        return ""
    end
...
'<span background="#4B696D" font="Inconsolata 11"> <span font="Inconsolata 11" color="#DDDDDD">$1%</span></span>', 5)
...
vicious.register(mpdwidget, vicious.widgets.mpd,
    function (mpdwidget, args)
        if args["{state}"] == "Stop" then 
            return '<span background="#313131" font="Inconsolata 11"><span font="Inconsolata 11" color="#EEEEEE">♪ - </span></span>'
        else 
            return '<span background="#313131" font="Inconsolata 11"><span font="Inconsolata 10" color="#EEEEEE">♪ '.. args["{Artist}"]..' - '.. args["{Title}"].. '</span></span>'
        end
    end, 10)
...
awful.key({ modkey,        }, "Escape", function() awful.util.spawn("systemctl poweroff") end),

-- {{ Spawns Sublime }} --

awful.key({ "Control", "Shift"}, "b", function() awful.util.spawn("/usr/bin/subl3") end),
